...
static const int sync_write_expire = 1250;	/* max time before a write sync is submitted. */
static const int async_read_expire = 500;	/* ditto for read async, these limits are SOFT! */
static const int async_write_expire = 2000;	/* ditto for write async, these limits are SOFT! */
